...
SENSOR_DESCRIPTIONS: tuple[IStoreSolarSensorEntityDescription, ...] = (
    ...
    IStoreSolarSensorEntityDescription(
        key=SENSOR_EXPERIMENTAL_TOTAL_GRID_IMPORTED_ENERGY,
        translation_key=SENSOR_EXPERIMENTAL_TOTAL_GRID_IMPORTED_ENERGY,
        device_key="meter",
        device_class=SensorDeviceClass.ENERGY,
    ...
    IStoreSolarSensorEntityDescription(
        key=SENSOR_EXPERIMENTAL_TOTAL_GRID_EXPORTED_ENERGY,
        translation_key=SENSOR_EXPERIMENTAL_TOTAL_GRID_EXPORTED_ENERGY,
        device_key="meter",
        device_class=SensorDeviceClass.ENERGY,
        entity_registry_enabled_default=False,
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
